const START_POINT_ID = "start-point";
const DEST_POINT_ID = "end-point";

function autoCompleteAddress(containerElement, id, placeholder, callback) {
    ...
    inputElement.addEventListener("input", function(e) {
        ...
        var promise = new Promise((resolve, reject) => {
            ...
            var apiKey = "af361475cd624479ab85363a1893eab1";
...
// starting point
autoCompleteAddress(
    document.getElementById("start-point-container"),
    "start-point",
